...
namespace _13TPI_Pet_Adoption_and_Foster_Centre_NZ.Controllers
{
    public class PetGroupsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PetGroupID,PetID,PetGroupName,PeGroupDescriptiom")] PetGroup petGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PetGroupID,PetID,PetGroupName,PeGroupDescriptiom")] PetGroup petGroup)
        {
